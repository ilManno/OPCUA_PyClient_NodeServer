...
class Ui_CardWidget(object):
    def setupUi(self, CardWidget):
        ...
        self.variablesView.setFocusPolicy(QtCore.Qt.NoFocus)
        ...
        self.variablesView.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        ...
        self.variablesView.horizontalHeader().setDefaultSectionSize(20)
        self.variablesView.horizontalHeader().setMinimumSectionSize(20)
        self.variablesView.verticalHeader().setVisible(False)
        self.variablesView.verticalHeader().setDefaultSectionSize(20)
        self.variablesView.verticalHeader().setMinimumSectionSize(20)
